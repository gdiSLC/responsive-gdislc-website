...
<section id="wanttolearn" class="detailed_info">
	<h1>Looking for a coding bootcamp in Utah? <span class="bold">Check these out!</span></h1>
	<p>Do you run a bootcamp in Utah? <strong>Let us know!</strong>
<!-- Would like to make 3 columns that look like boxes ala DevPoint site -->
	<hr>
	<p>
		...
		They offer scholarships for <h3>Women in Technology ($2000)</h3>
	</p><hr>
	<p>
